...
spec: docs/superpowers/specs/2026-07-07-subscription-rexxar-detail-cache-design.md
related_adr: docs/adr/0002-subscription-state-convergence.md
---

# Subscription Rexxar Detail Cache Implementation Plan

> Historical implementation record: the user-visible metadata behavior remains implemented, but the
> `WantedSubscriptionRecord`/`WantedSubscriptionStore` and watcher references below describe the
> original implementation. Current Poll and persistence use the latest-only repository defined by the
> [architecture convergence PRD](../specs/2026-07-11-project-architecture-convergence-prd.md).
